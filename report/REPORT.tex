...
The new and improved algorithm has been made parallel using MPI. This introduced some overhead, but still greatly reduced the running time due to several processes running on the data. The implementation is still linear.
